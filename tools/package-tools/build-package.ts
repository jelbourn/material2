...
export class BuildPackage {
  ...
  private async _compileBothTargets(secondaryEntryPoint = '') {
    return Promise.all([
      compileEntryPoint(this, buildTsconfigName, secondaryEntryPoint),
      compileEntryPoint(this, buildTsconfigName, secondaryEntryPoint, this.esm5OutputDir),
    ]).then(() => renamePrivateReExportsToBeUnique(this, secondaryEntryPoint));
  }
