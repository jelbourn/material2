...
import {dispatchMouseEvent, dispatchKeyboardEvent} from '@angular/cdk/testing/private';
...
describe('MenuItemTrigger', () => {
  ...
  describe('standalone', () => {
    ...
    it('should have the standalone trigger class', () => {
      expect(nativeTrigger.classList.contains('cdk-standalone-menu-item')).toBeTrue();
    });
    ...
    it('should close the open menu when clicking on an inline menu item', () => {
      ...
      dispatchMouseEvent(fixture.componentInstance.nativeInlineItem.nativeElement, 'mousedown');
      detectChanges();
